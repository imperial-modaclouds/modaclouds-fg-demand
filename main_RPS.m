function demandEst = main_RPS(data, initSample, sampleSize, V)
% MAIN_RPS setups the input data for the RPS estimation method and calls it
%
...
% run ERPS method
demandEst = des_RPS(rtExp, classExp, qlExp, V); 
